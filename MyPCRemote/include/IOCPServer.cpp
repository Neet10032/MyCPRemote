...
//////////////////////////////////////////////////////////////////////////////////////////
		if (!bError)
		{
			if(bIORet && NULL != pOverlapPlus && NULL != lpClientContext) 
			{
				try
				{
					MyOutputDebugString("ThreadPoolFunc() IOType:%d IOSize:%d pContext:%p", pOverlapPlus->m_ioType, dwIoSize, lpClientContext);
...
bool CIOCPServer::OnClientInitializing(ClientContext* pContext, DWORD dwIoSize)
{
	...
	MyOutputDebugString("OnClientInitializing ClientContext:%p dwIoSize:%d", pContext, dwIoSize);
...
{
	MyOutputDebugString("OnClientReading ClientContext:%p dwIoSize:%d", pContext, dwIoSize);
